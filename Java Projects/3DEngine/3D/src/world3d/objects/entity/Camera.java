...
public class Camera extends Object3d {
    ...
    private Vertex projectVertex(Vertex vertex) {
        ...
        Vector distance = new Vector(pointOnPlane, picturePlane.getVtx1());
        System.out.println(pointOnPlane.getDistanceFromPoint(picturePlane.getVtx1()));
        ...
        vertex.setP2d(new Point2d(Math.sin(angle) * length * (panel.getWidth() / picturePlane.getW()), Math.cos(angle) * length * (panel.getHeight() / picturePlane.getH())));
