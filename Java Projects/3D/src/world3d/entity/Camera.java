...
public class Camera extends Object3d {
    ...
    private Vertex projectVertex(Vertex vertex) {
        ...
        */
        ...
        vertex.setP2d(new Point2d(Math.cos(angle) * length * panel.getWidth(), Math.sin(angle) * length * panel.getHeight()*picturePlane.getAspectRatio()));
    ...
    private void updatePicturePlane() {
        picturePlane = new PicturePlane(observer.addDistanceAlongVector(orientation.getForwardDirection(), 1).addDistanceAlongVector(orientation.getRightDirection(), -panel.getAspectRatio() * fov / 2).addDistanceAlongVector(orientation.getUpDirection(), fov / 2),
