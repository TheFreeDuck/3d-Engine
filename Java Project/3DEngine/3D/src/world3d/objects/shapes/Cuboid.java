...
public class Cuboid {
    ...
    public Cuboid(Point3d p1, double w, double h, double l) {
        ...
        this.vtx2 = vtx1.addDistance(0, 0, h);
        this.vtx3 = vtx2.addDistance(0, w, 0);
        this.vtx4 = vtx3.addDistance(0, 0, -h);
        this.vtx5 = vtx1.addDistance(l, 0, 0);
        this.vtx6 = vtx5.addDistance(0, 0, h);
        this.vtx7 = vtx6.addDistance(0, w, 0);
        this.vtx8 = vtx7.addDistance(0, 0, -h);
